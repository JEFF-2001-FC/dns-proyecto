  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-3xl font-semibold tracking-tight">Adolescentes</h1>
        <p className="mt-2 text-zinc-500">Gestiona los adolescentes y su pertenencia a un Ágape.</p>
      </div>
